    ...
    <div className="add_bio_wrap">
      {rel ? (
        ...
        >
          ...
          <option value="Amo solo i soldi">Amo solo i soldi</option>
          <option value="Amo tutti">Amo tutti</option>
        </select>
      ) : (
        <textarea
      ...
      {!detail && <div className="remaining">{max} Caratteri rimanenti</div>}
      <div className="flex">
